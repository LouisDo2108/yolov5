...
python val.py \
--img 480 --batch 1 \
--data /home/htluc/datasets/aim_folds/fold_4/annotations/aim_fold_4.yaml \
--weights /home/htluc/yolov5/runs/train/yolov5s_fold_4/weights/best.pt \
--verbose --save-json \
--name 'yolov5s_fold_3_val' \
